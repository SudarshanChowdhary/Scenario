...
function Recently_Published() {
	alert("kjashlkjhlaksjdhflkasjdfhlkj");
	$("#main_bg_image").hide();
	$("#Recently_Published").show();
...
function Emerging_Issues() {
	alert("kjashlkjhlaksjdhflkasjdfhlkj");
	$("#main_bg_image").hide();
	$("#Emerging_Issues").show();

}

function MyHandled_Case() {
	alert("kjashlkjhlaksjdhflkasjdfhlkj");
	$("#main_bg_image").hide();
	$("#My_Handled_Cases").show();
	...
	$("#customRadioGroup li").on("click", function (event) {
		...
		if ($(this).attr('aria-checked') == "true") {
			...
			if (i == slides[currentSlide].answer) { //change the scenario id
				...
				$(".nav_btn.next_btn").show();
				setTimeout(function () {
					$('#answer-sel').empty().text('Selection is Correct');
				}, 500);
			} else {
				$(".button_" + (i + 1)).addClass("incorrect");
				$(".feedback_container").addClass('incorrect show');
				...
				setTimeout(function () {
					$('#answer-sel').empty().text('Selection is Wrong');
				}, 500);
				setTimeout(function () {
					$('#answer-sel').empty();
				}, 700);
